...
module GlobalConfiguration
  ...
  class GlobalConfig < Hash
    ...
    # "on_prem" should be included in on_prem secret file
    # "vsphere" should be included in vsphere secret file
    def defaults
    ...
    def load_secrets
      ...
      on_prem_secrets = %w(on_prem-api-host on_prem-log-level on_prem-oauth-endpoint on_prem-api-endpoint on_prem-organization-id on_prem-api-scope on_prem-collector-version on_prem-registration-date on_prem-machines-by-inv-timestamp)
      store_secrets_for(vsphere_secrets, "vsphere")
      store_secrets_for(on_prem_secrets, "on_prem")
    end
